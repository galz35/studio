...
var AdminController = function () {
    ...
    var _getUsuarios_decorators;
    var _getMedicos_decorators;
    var AdminController = _classThis = /** @class */ (function () {
        ...
        AdminController_1.prototype.crearUsuario = function (crearUsuarioDto) {
            return this.adminService.crearUsuario(crearUsuarioDto);
        };
        AdminController_1.prototype.getUsuarios = function (req) {
            return this.adminService.getUsuarios(req.user.pais);
        };
        AdminController_1.prototype.getMedicos = function (req) {
    ...
    (function () {
        ...
        _getDashboard_decorators = [(0, common_1.Get)('dashboard'), (0, swagger_1.ApiOperation)({ summary: 'Obtener KPIs del dashboard de admin' })];
        _crearUsuario_decorators = [(0, common_1.Post)('usuarios'), (0, swagger_1.ApiOperation)({ summary: 'Crear un nuevo usuario' })];
        _getUsuarios_decorators = [(0, common_1.Get)('usuarios'), (0, swagger_1.ApiOperation)({ summary: 'Listar usuarios del país' })];
        _getMedicos_decorators = [(0, common_1.Get)('medicos'), (0, swagger_1.ApiOperation)({ summary: 'Listar médicos del país' })];
        ...
        __esDecorate(_classThis, null, _getUsuarios_decorators, { kind: "method", name: "getUsuarios", static: false, private: false, access: { has: function (obj) { return "getUsuarios" in obj; }, get: function (obj) { return obj.getUsuarios; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _getMedicos_decorators, { kind: "method", name: "getMedicos", static: false, private: false, access: { has: function (obj) { return "getMedicos" in obj; }, get: function (obj) { return obj.getMedicos; } }, metadata: _metadata }, null, _instanceExtraInitializers);
